...
A core rule of the risk management framework is that position size will \textbf{only} be increased if the system's rolling APR is trending positively and is above the dynamically calculated APR target. This ensures that risk is escalated only during periods of sustained, proven profitability.
